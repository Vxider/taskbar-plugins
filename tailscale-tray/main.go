...
func newLogger() *log.Logger {
	...
	if cacheDir, err := os.UserCacheDir(); err == nil {
		logDir := filepath.Join(cacheDir, "tailscale-tray")
		if err := os.MkdirAll(logDir, 0o755); err == nil {
			logPath := filepath.Join(logDir, "tailscale-tray.log")
	...
	return log.New(writer, "tailscale-tray: ", log.LstdFlags|log.Lmsgprefix)
}
...
func acquireSingleInstance(logger *log.Logger, replaceExisting bool) bool {
	...
	lockPath := filepath.Join(runtimeDir, "tailscale-tray.lock")
